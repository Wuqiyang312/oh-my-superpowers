...
- 仓库根目录的 **`AGENTS.md`**，或
- 如果存在，仓库根目录的 **`CONTEXT-MAP.md`** —— 它指向每个上下文的一个 `AGENTS.md`。阅读与主题相关的每一个。
- **`docs/agents/`** —— 阅读触及你将要工作领域的配置文件。
...
当你的输出命名领域概念时（在 issue 标题、重构提议、假设、测试名中），使用 `AGENTS.md` 中定义的术语。不要滑向词汇表明确避免的同义词。
