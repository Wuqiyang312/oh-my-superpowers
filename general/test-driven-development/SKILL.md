...
以下参考文档提供 TDD 相关领域的深层指导：

- **`tests.md`** — 好测试 vs 坏测试的详细对比，含代码示例
- **`mocking.md`** — 何时 Mock、如何设计可 Mock 的接口
- **`refactoring.md`** — TDD 重构阶段的候选模式清单
- **`deep-modules.md`** — 深度模块 vs 浅层模块的设计哲学
- **`interface-design.md`** — 面向可测试性的接口设计原则
